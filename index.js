...
if (todos != null) {
  ...
  defaultProject.name = 'Today Project';
  const defaultTask = new Task;
  defaultTask.name = 'Walking';
  defaultProject.tasks.push(defaultTask);
  todoList.projects.push(defaultProject);
            ...
            deleteTaskButton.addEventListener('click', () => {
             ...
             const circleTask = document.getElementById(`circle-icon-${index}`);   
                 circleTask.addEventListener('click', () => {
                  ...
                  if (todoList.projects[currentIndex].tasks[index].done != true) {
                  ...
                  console.log(todoList.projects[currentIndex].tasks[index]);
                  localStorage.setItem("todos", JSON.stringify(todoList));
                })                             
}
